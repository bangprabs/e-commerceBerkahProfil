                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3 mb-md-30px mb-lm-30px">
                        <div class="single-wedge">
                            <div class="footer-logo">
                                <a href="index.html"><img src="{{url('front_assets/images/logo/logo-dark.png')}}" class="w-100"
                                        alt=""></a>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3 col-sm-12">
                        <div class="single-wedge">
                            ...
                            <div class="footer-links">
                                <!-- News letter area -->
                                <p class="address">Address: Jalan Bedahan RT 008/002, No. 47. Pabuaran Mekar, Cibinong</p>
                                <p class="phone">Phone/Fax:<a href="tel:082110984618"> 0821 1098 4618</a></p>
                                <p class="mail">Email:<a href="mailto:berkahprofil@gmail.com"> berkahprofil@gmail.com</a>
                                </p>
                                <p class="mail"><a href="https://berkahprofil@gmail.com"> berkahprofil@gmail.com</a></p>
                    ...
                    <div class="row flex-md-row-reverse align-items-center">
                        <div class="col-md-6 text-center text-md-end">
                            <div class="payment-mth"><a href="#"><img class="img img-fluid"
                                        src="{{url('front_assets/images/icons/payment.png')}}" alt="payment-image"></a></div>
                        </div>
                        <div class="col-md-6 text-center text-md-start">
                            <p class="copy-text"> © 2021 <strong>Berkah Profil Team</strong> Made With <i class="fa fa-heart"
                                    aria-hidden="true"></i> By <a class="company-name"
                                    href="#">
                                    <strong> Agung Prabowo </strong></a>.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    s1.async=true;
    s1.src='https://embed.tawk.to/61a82f4953b398095a670db9/1flsfheqj';
    s1.charset='UTF-8';
