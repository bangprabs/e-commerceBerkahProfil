<div class="page-header">
    <div class="header-wrapper row m-0">
      ...
      <div class="header-logo-wrapper col-auto p-0">
        <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="{{url('/admin_assets/images/logo/logo.png')}}" alt=""></a></div>
        ...
        <ul class="nav-menus">
          ...
          <li class="cart-nav onhover-dropdown">
            ...
            <ul class="cart-dropdown onhover-show-div">
              ...
              <li class="mt-0">
                <div class="media"><img class="img-fluid rounded-circle me-3 img-60" src="{{url('/admin_assets/images/ecommerce/01.jpg')}}" alt="">
              ...
              <li class="mt-0">
                <div class="media"><img class="img-fluid rounded-circle me-3 img-60" src="{{url('/admin_assets/images/ecommerce/03.jpg')}}" alt="">
                  <div class="media-body"><span>V-Neck Shawl Collar Woman's Solid T-Shirt</span>
                    <p>Yellow(#fcb102)</p>
                    <div class="qty-box">
                      <div class="input-group"><span class="input-group-prepend">
          ...
          <li class="onhover-dropdown"><i data-feather="message-square"></i>
            <ul class="chat-dropdown onhover-show-div">
              ...
              <li>
                <div class="media"><img class="img-fluid rounded-circle me-3" src="{{url('/admin_assets/images/user/1.jpg')}}" alt="">
              ...
              <li>
                <div class="media"><img class="img-fluid rounded-circle me-3" src="{{url('/admin_assets/images/user/2.jpg')}}" alt="">
                  <div class="status-circle online"></div>
              ...
              <li>
                <div class="media"><img class="img-fluid rounded-circle me-3" src="{{url('/admin_assets/images/user/4.jpg')}}" alt="">
          ...
          <li class="profile-nav onhover-dropdown p-0 me-0">
            <div class="media profile-media"><img class="b-r-10" style="width: 35px;" src="{{url('images/admin_images/admin_photos/'.Auth::guard('admin')->user()->image)}}" alt="">
              <div class="media-body"><span>{{ ucwords(Auth::guard('admin')->user()->name) }}</span>
            ...
            <ul class="profile-dropdown onhover-show-div">
              ...
              <li><a href="{{ url('admin/logout') }}"><i data-feather="log-out"> </i><span>Log out</span></a></li>
            </ul>
          </li>
        </ul>
      </div>
