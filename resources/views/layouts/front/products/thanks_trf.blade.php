        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
                <div class="inner_complated">
                    ...
                    <h3>Terima kasih telah membeli produk di website kami, Pesanan anda masih berstatus <strong>Pending</strong></h3>
                    ...
                    <p class="dsc_cmpted">Harap upload bukti pembayaran pada halaman detail order anda.</p>
