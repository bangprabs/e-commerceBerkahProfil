...
$(document).ready(function () {
     ...
     $(".customizer-color li").on('click', function() {
        ...
        $("#color" ).attr("href", "../admin_assets/css/"+color+".css" );
    ...
    $('.sidebar-type li').on('click', function () {
        ...
        switch (type) {
            ...
            case 'normal-sidebar': {
                ...
                $(".logo-wrapper").find('img').attr('src', '../admin_assets/images/logo/logo.png');
