...
class UserController extends Controller
{
    ...
    {
        $page_name = "";
        return view('layouts.front.users.login_page')->with(compact('page_name'));
    }

    public function registerPage()
    {
        $page_name = "";
        return view('layouts.front.users.register_page')->with(compact('page_name'));
    }
        ...
        if ($request->isMethod('post')) {
            ...
            if (Auth::attempt(['email'=>$data['email'], 'password'=>$data['password']])) {
                ...
                if ($userStatus->status == 0) {
                    Auth::logout();
                    $message = "Anda belum mengaktivasi akun, harap cek email anda untuk mengaktivasi akun !";
                    session::flash('error_message', $message);
                    return redirect()->back();
                }
    ...
    public function forgotPassword(Request $request)
    {
        ...
        return view('layouts.front.users.forgot_password')->with(compact('page_name'));
    }
    ...
    public function account(Request $request)
    {
        ...
        return view('layouts.front.users.account')->with(compact('userDetails', 'countries', 'page_name', 'orders', 'blogCategory', 'city', 'province'));
    }
